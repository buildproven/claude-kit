...
export function registerBacklinksTools(
  server: McpServer,
  ...
  registerTool(
    ...
    async (_params, client) => {
      const response =
        await client.get<DataForSeoResponse<any>>('/backlinks/index')
  ...
  registerTool(
    ...
    async (_params, client) => {
      const response =
        await client.get<DataForSeoResponse<any>>('/backlinks/errors')
  ...
  registerTool(
    ...
    async (_params, client) => {
      const response =
        await client.get<DataForSeoResponse<any>>('/backlinks/id_list')
