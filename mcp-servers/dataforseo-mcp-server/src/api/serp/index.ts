...
export function registerSerpTools(
  server: McpServer,
  ...
  registerTool(
    ...
    async (params, client) => {
      const response = await client.post<
        DataForSeoResponse<GoogleOrganicLiveResult>
      >('/serp/google/organic/live', [params])
  ...
  registerTaskTool(
    ...
    async (id, client) => {
      const response = await client.get<
        DataForSeoResponse<TaskGetResponse<GoogleOrganicTaskResult>>
