...
export function registerContentGenerationTools(
  server: McpServer,
  ...
  registerTool(
    ...
    z.object({
      ...
      writer_experience_level: z
        .enum(['expert', 'beginner', 'intermediate'])
        .optional()
        .describe('Writer experience level'),
      subject_experience_level: z
        .enum(['expert', 'beginner', 'intermediate'])
        .optional()
        .describe('Subject experience level'),
  ...
  registerTool(
    ...
    z.object({
      ...
      explanation_type: z
        .enum(['line_by_line', 'function', 'block'])
        .optional()
