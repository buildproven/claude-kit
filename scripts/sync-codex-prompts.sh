...
# Paths
CLAUDE_CONFIG_DIR="$HOME/Projects/claude-setup"
...
- `/prompts:bs-execute` - TDD development cycle
- `/prompts:bs-test` - Run tests
- `/prompts:bs-review` - Code review
