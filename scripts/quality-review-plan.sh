...
case "$QUALITY_REVIEW_TIER" in
  ...
  medium|95) QUALITY_REVIEW_TIMEOUT=300; QUALITY_REVIEW_FOCUS="Broad correctness, security, type-safety, and silent-failure review." ;;
  high|98) QUALITY_REVIEW_TIMEOUT=480; QUALITY_REVIEW_FOCUS="Deep adversarial review: bugs, security, data loss, races, compatibility, and rollback safety." ;;
  critical) QUALITY_REVIEW_TIMEOUT=600; QUALITY_REVIEW_FOCUS="Critical release-veto review. Assume the change is unsafe; require concrete evidence before approval. Check security, data loss, supply chain, deployment, rollback, and break-glass behavior." ;;
