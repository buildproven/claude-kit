...
4. Call `perplexity_ask` to ground the evaluation in current market reality:

```
"Who is already building or selling [idea/space]? What are the closest existing products, and what are people paying for them? Are there any recent launches or pivots in this space?"
```
...
```
"Is there public evidence of demand for [idea]? Look for: people paying for it, desperate forum posts, Reddit/Twitter complaints about the problem, or indie products gaining traction in this space."
```
...
```
"How are [buyer type] currently solving [problem] without [idea]? What tools, workflows, or manual processes are they using? What do they hate about the current approach?"
```
