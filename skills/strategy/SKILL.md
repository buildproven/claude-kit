...
/bs:strategy "Which offer should we sell first?" --artifact docs/positioning-memo.md,docs/niche-assessment.md --output scorecard --rubric "pain clarity,authority fit,speed to first sale,market size,moat" --persist docs/strategic-notes/offer-decision.md
```
