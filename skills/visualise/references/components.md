...
>
  <p
    style="font-size: 13px; color: var(--color-text-secondary); margin: 0 0 2px;"
  >
    Label
  </p>
...
<div style="display: flex; align-items: center; gap: 12px; margin: 0 0 1.5rem;">
  ...
  />
  <span style="font-size: 14px; font-weight: 500; min-width: 24px;" id="out"
    >20</span
  >
</div>
...
>
  <div
    style="background: var(--color-background-primary); border: 0.5px solid var(--color-border-tertiary); border-radius: var(--border-radius-lg); padding: 1rem 1.25rem;"
  >
    <p
      style="font-weight: 500; font-size: 15px; margin: 0 0 12px; color: var(--color-text-info);"
    >
      Option A
    </p>
  </div>
...
<div
  style="display: flex; align-items: center; justify-content: space-between; padding-top: 12px; border-top: 0.5px solid var(--color-border-tertiary);"
>
...
<script>
  ...
  function render() {
    ...
    document.getElementById("dots").innerHTML = steps
      .map(
        (_, i) =>
...
```html
<div
  style="background: var(--color-background-secondary); border-radius: var(--border-radius-lg); padding: 2rem; display: flex; justify-content: center;"
>
  <!-- mockup -->
</div>
```
...
```html
<div
  style="min-height: 400px; background: rgba(0,0,0,0.45); display: flex; align-items: center; justify-content: center; border-radius: var(--border-radius-lg);"
>
  <div
    style="background: var(--color-background-primary); border-radius: var(--border-radius-lg); padding: 2rem; max-width: 400px; width: 100%;"
  >
    <!-- content -->
  </div>
</div>
