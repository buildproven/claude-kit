...
<!--
  Derived from the `frontend-design` skill in https://github.com/anthropics/skills
  ...
  MODIFIED by buildproven from the original:
    ...
    - added an AI-ism denylist and a mandatory self-review pass
    - added the "Design Reference Data" section and the bundled data/*.csv files
      (the CSVs are original buildproven work, MIT — see NOTICE)
-->
