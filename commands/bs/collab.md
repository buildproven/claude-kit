...
For task-type-to-model routing decisions (when to use Codex vs Gemini vs Claude for ad-hoc delegation), see:

`docs/acpx-model-routing.md` — routing table, `acpx exec` shell patterns, and `--no-wait` guidance.
