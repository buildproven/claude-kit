---
name: refactor
description: Focused refactoring session with jscpd, knip, and code simplification
...
After fixing quality issues, run the code-simplifier plugin if installed:
